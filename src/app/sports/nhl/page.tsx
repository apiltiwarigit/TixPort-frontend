...
const mockNHLEvents = [
  ...
  {
    id: 3,
    title: 'New York Islanders vs Pittsburgh Penguins',
    venue: 'UBS Arena',
    location: 'Elmont, NY',
    date: '2024-11-08',
    time: '7:00 PM',
...
export default function NHLPage() {
  ...
  const [filteredEvents, setFilteredEvents] = useState(mockNHLEvents);

  useEffect(() => {
    let filtered = mockNHLEvents;
    ...
    <PageContainer showSidebar={true} sidebar={<Sidebar />}>
      <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
              <div>
                ...
                <p className="text-gray-400 text-sm sm:text-base">
                  National Hockey League games for the 2024-25 season
                </p>
              </div>
              <LocationDisplay
          ...
          <div className="mb-4 sm:mb-6">
            <p className="text-gray-400 text-sm sm:text-base">
              Showing {filteredEvents.length} NHL games
          ...
          {filteredEvents.length === 0 && (
            <div className="text-center py-12 sm:py-16">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">No NHL games found</h3>
              <p className="text-gray-400 text-sm sm:text-base mb-6">
                Try adjusting your search or team filters to find more NHL games.
              </p>
              <Button
                onClick={() => {
                  setSearchQuery('');
