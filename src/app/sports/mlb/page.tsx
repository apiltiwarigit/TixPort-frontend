...
// Mock MLB data - will be replaced with API calls later
const mockMLBEvents = [
  {
    id: 1,
...
const teams = [
  ...
  'Philadelphia Phillies', 'Toronto Blue Jays', 'Atlanta Braves',
...
export default function MLBPage() {
  ...
  const [filteredEvents, setFilteredEvents] = useState(mockMLBEvents);

  useEffect(() => {
    let filtered = mockMLBEvents;
    ...
    <PageContainer showSidebar={true} sidebar={<Sidebar />}>
      <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
              <div>
                ...
                <p className="text-gray-400 text-sm sm:text-base">
                  Major League Baseball games for the 2024 season
                </p>
              </div>
              <LocationDisplay
          ...
          <div className="mb-4 sm:mb-6">
            <p className="text-gray-400 text-sm sm:text-base">
              Showing {filteredEvents.length} MLB games
          ...
          {filteredEvents.length === 0 && (
            <div className="text-center py-12 sm:py-16">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">No MLB games found</h3>
              <p className="text-gray-400 text-sm sm:text-base mb-6">
                Try adjusting your search or team filters to find more MLB games.
              </p>
              <Button
                onClick={() => {
                  setSearchQuery('');
