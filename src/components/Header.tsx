        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-1 max-w-2xl mx-4 lg:mx-8">
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field w-full pl-10 pr-3 py-3 text-sm"
                />
              </div>
            </div>
            ...
            <nav className="hidden lg:flex items-center space-x-6">
              <Link href="/login" className="text-gray-300 hover:text-white text-sm font-medium flex items-center space-x-1">
              ...
              <Link href="/cart" className="text-gray-300 hover:text-white text-sm font-medium relative">
